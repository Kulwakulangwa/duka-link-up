...
export function ShopLinkCard({ url, label = "Your shop link", className = "" }: ShopLinkCardProps) {
  ...
  return (
    ...
    >
      ...
      {copied && (
        <span className="absolute top-3 right-4 text-[11px] font-mono text-[#00C9A7] bg-[#00C9A7]/10 border border-[#00C9A7]/30 px-2 py-0.5 rounded-md">
          Copied!
        </span>
      )}
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="font-mono text-sm text-white/90 break-all">{url}</span>
        </div>
