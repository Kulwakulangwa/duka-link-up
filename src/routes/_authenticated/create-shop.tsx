...
function Dashboard() {
  ...
  // Refresh data when window gets focus (after returning from shop creation)
  useEffect(() => {
  ...
  // ✅ SHOW CREATE SHOP SCREEN FOR NEW USERS (with full header and settings button hidden)
  if (!shop) {
    return (
  ...
  // ✅ DASHBOARD FOR USERS WITH SHOPS (ALL YOUR ORIGINAL FEATURES INTACT)
  return (
    <main className="min-h-screen bg-background">
      <header className="px-5 py-4 border-b border-border bg-card/50 backdrop-blur sticky top-0 z-10">
        <div className="max-w-3xl mx-auto flex items-center justify-between gap-3">
          ...
          <>
            ...
            <div className="flex items-center justify-between">
              <h2 className="font-semibold text-foreground">
                Products <span className="text-muted-foreground font-normal">
                  ({products.length}/{FREE_PRODUCT_LIMIT})
                </span>
              </h2>
